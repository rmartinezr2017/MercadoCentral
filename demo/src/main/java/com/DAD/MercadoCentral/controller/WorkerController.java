...
public class WorkerController {
	...
	public String modProductData(Model m, HttpSession session, @PathVariable long id,
	...
	public String selectBarcode(Model m, HttpSession session, @PathVariable long id) {
	...
	public String selectBarcode(Model m, HttpSession session, @PathVariable long id, @PathVariable long barcodeId) {
	...
	public String selectBarcode(Model m, HttpSession session) {
	...
	public String modProductData(Model m, HttpSession session, @RequestParam long barcode) {
	...
	public String deleteBarcode(Model m, HttpSession session, @PathVariable long barcodeId) {
	...
	public String asignedBarcode(Model m, HttpSession session, @PathVariable long barcodeId) {
	...
	public String addProductData(Model m, HttpSession session, @RequestParam long id,
																			 String name, 
																			 int price, 
																		 	 int stock) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	@GetMapping("/{id}")
	public String addWorker(Model m, HttpSession session, @PathVariable long id) {
	...
	public String modWorkerData(Model m, HttpSession session, @PathVariable long id,
	...
	public String addWorker(Model m, HttpSession session) {
	...
	public String modWorkerData(Model m, HttpSession session, @RequestParam String nickname, 
															  String nombre, 
															  Boolean admin, 
															  String password) {
	...
	public String deleteWorker(Model m, HttpSession session, @PathVariable long id) {
...
//TODO hacer los HTML y los controladores
//TODO Hacer la parte de Worker
//TODO Hacer el header y footer de todo